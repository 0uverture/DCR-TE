...
\pagebreak
	...
	The three primary components of the proposed solution are as follows: the workflow, which will be described with DCR, Intel SGX and method for achieving distributed consensus.
		...
		The only key which Intel do not possess is the Seal Key \cite{intel-sgx-explained}, which is used for the sealing of enclaves, meaning that even Intel would theoretically not have access to sealed enclaves.
      ...
      % distinguising between running enclave instances
			...
			The specific details of the remote attestation is then up to the API exposed by the ISV \footnote{Outlined here: \url{https://software.intel.com/en-us/articles/intel-software-guard-extensions-remote-attestation-end-to-end-example}}.
