...
\pagebreak
	...
	This is done by using the so-called \textit{strawman design} where a request is sent to a node, the primary, who prepares a vote, by distributing parts of a secret to all nodes.
